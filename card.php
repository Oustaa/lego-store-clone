...
<body>
    ...
    <div class="container my-5">
        <main>
            <header>
                <h2 class="display-4 text-center">Card</h2>
                <hr class="bg-warning py-1 rounded-1" style="width:20% ; margin-inline: auto;">
            </header>
            <div class="row">
                <div class="col-12 col-lg-7">
                    <h1 class="display-6">Cart Items</h1>
                    <div id="cardItems">

                    </div>
                </div>
                <div class="col-12 col-lg-5 sticky-top">
                    <h3 class="display-6">Order Summary</h3>
                    <div class="row">
                        <div class="col-12 d-flex justify-content-between mt-3">
                            <h5 class="text-muted">Oreder value (0) items:</h5>
                            <h5 id="totalPrice" class="">00.00$</h5>
                        </div>
                        <div class="col-12 d-flex justify-content-between mt-3">
                            <h5 class="text-muted">TVA (15%):</h5>
                            <h5 id="TVA" class="">00.00$</h5>
                        </div>
                        <div class="col-12 d-flex justify-content-between mt-3">
                            <h5 class="text-muted">Total:</h5>
                            <h5 id="finalPrice" class="">00.00$</h5>
                        </div>
                    </div>
                </div>
            </div>
